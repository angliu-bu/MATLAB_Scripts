...
start_power = 6.6; % Low end of power range
end_power = 19; % High end of power range
dP = 0.1;
...
for lock_in_freq = 7.495e6
    for harmonic = [1]
        ...
        file_base = ['PowerSweep_InputSignal_' ...

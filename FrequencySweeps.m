...
f_start = 6e5; % Sweep start frequency
f_stop = 7e5; % Sweep stop frequency
res_BW = 200; % measurement bandwidth
...
for f_start = 1e6:1e6:250e6
    ...
    spectrum_analyzer.set_ref_level(-15);
    ...
    signal_generator.set_dwell_time(2000*sweep_dwell_time);
    ...
    % Save data to file
    filename = ['Data/2017-12-18/I15-' num2str(f_start/1e6) 'MHz.txt'];
